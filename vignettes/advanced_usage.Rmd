...
p1 <- genome_plot(
  ez_signal(data = signal_data, fill = "steelblue", region = region1),
...
p2 <- genome_plot(
  ez_signal(data = signal_data, fill = "steelblue", region = region2),
