...
Signal tracks are used to visualize continuous data, such as coverage from RNA-seq or ATAC-seq experiments. The `ez_signal()` function creates a signal track from a data frame or a bigWig file.

```{r}
# Create a signal track from the example data
signal_track <- ez_signal(
  data = example_signal,
  fill = "steelblue",
  color = "navy",
  type = "area"
...
# Apply the ez_signal_theme to the signal track
signal_track_signal_themed <- signal_track + ez_signal_theme()
