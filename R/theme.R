...
ez_theme <- function(base_size = 10, base_family = "", base_line_size = 0.2,
  ...
  theme <- theme + ggplot2::theme(
    # Remove panel grid
    panel.grid.major = ifelse(show_grid, ggplot2::element_line(color = "gray90", linewidth = 0.15), ggplot2::element_blank()),
    ...
    # Customize axis
    axis.line.x = ifelse(show_x_axis, ggplot2::element_line(color = "black", linewidth = 0.15), ggplot2::element_blank()),
    axis.line.y = ifelse(show_y_axis, ggplot2::element_line(color = "black", linewidth = 0.15), ggplot2::element_blank()),
    axis.ticks = ifelse(show_ticks, ggplot2::element_line(color = "black", linewidth = 0.15), ggplot2::element_blank()),
